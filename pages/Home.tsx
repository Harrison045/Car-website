...
const TESTIMONIALS = [
  {
    quote:
      "The most seamless acquisition experience I've had in a decade. Lumina doesn't just sell cars; they curate icons that define your legacy.",
  ...
  {
    quote:
      "Their attention to mechanical precision and aesthetic detail is unparalleled. A true masterclass in the philosophy of luxury mobility.",
    author: "Elena Rossi",
  ...
  {
    quote:
      "Exceptional concierge service. From the first inquiry to the final delivery, every touchpoint was handled with pure, professional perfection.",
    author: "Julian Vane",
...
const FAQ_CATEGORIES = [
  {
    ...
    questions: [
      {
        q: "What is the minimum operator age?",
        a: "Lumina assets require the operator to be at least 25 years of age. For specific Tier-1 hypercars, the minimum age is 30, supplemented by a mandatory safety induction.",
      },
      {
        q: "Can I request delivery to a private hangar?",
        a: "Absolute portability is our standard. We provide white-glove delivery to private airfields, yacht clubs, and residential estates globally.",
      },
      {
        q: "Is there a maximum mileage limit?",
        a: "Standard daily allocations include 150 miles. Extended mileage packages can be customized during the initial booking sequence.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        q: "What level of coverage is provided?",
        a: "Every asset is secured with comprehensive elite-tier insurance. A security hold is required via Lumina Select Vault, which is released immediately upon asset reintegration.",
      },
      {
        q: "How does biometric access work?",
        a: "Our fleet uses encrypted biometric tokens. You will receive a secure digital key linked to your identity for the duration of the possession cycle.",
      },
    ],
  },
];
...
const Home: React.FC = () => {
  ...
  const handleSearch = () => {
    ...
    navigate(
      `/inventory?make=${filterMake}&bodyType=${filterBody}&maxPrice=${price}`,
    );
  };
  ...
  const OFFERS =
    cars.length > 0
      ? cars.map((car) => ({
          ...
          make: car.make || "",
          model: car.model || "",
          price: car.rentPrice || Math.round((car.price || 0) / 400),
          image: car.image || "",
  ...
  useEffect(() => {
    const heroTimer = setInterval(
      () => setCurrentHeroCarIdx((prev) => (prev + 1) % cars.length),
      8000,
    );
    ...
    <div className="bg-white">
      ...
      >
        <div className="absolute inset-0 z-0">
          ...
          >
            <source
              src="/GT3RS NIGHT RUN [4K] - werqshop (1080p, h264) (1).mp4"
              type="video/mp4"
            />
          ...
          >
            ...
            <div className="max-w-3xl space-y-4 block md:hidden">
              ...
              <p className="text-[13px] sm:text-[14px] text-white/70 max-w-xl leading-relaxed">
                Commission rare performance icons hand-delivered across Italy.
                From Milan runways to coastal roads, every detail is
                orchestrated by our private concierge team.
              </p>
                ...
                <Link to={`/car/${currentHeroCar.id}`}>
                  <div className="flex justify-between items-center mb-4">
                    <div className="flex flex-col">
                      <span className="font-bold text-base text-black leading-none">
                        $
                        {(
                          currentHeroCar.rentPrice ||
                          Math.round(currentHeroCar.price / 300)
                        ).toLocaleString()}
                        /day
                      </span>
                      {currentHeroCar.status === "Reserved" && (
                        <span className="text-[7px] font-black uppercase tracking-widest text-amber-600 mt-1">
                          RESERVED
                        </span>
                      )}
                    </div>
          ...
          <div className="bg-neutral-900/95 backdrop-blur-md rounded-2xl p-2 md:p-3 flex flex-col lg:flex-row items-center shadow-2xl border border-white/10">
            <div className="flex-1 grid grid-cols-1 md:grid-cols-3 w-full divide-y md:divide-y-0 md:divide-x divide-white/10">
              ...
              <CustomSelect
                ...
                options={[
                  "All",
                  ...Array.from(new Set(cars.map((c) => c.make || ""))).filter(
                    Boolean,
                  ),
                ]}
              ...
              <div className="px-5 py-3 hover:bg-white/5 transition-colors cursor-pointer group relative rounded-xl">
                <p className="text-[9px] font-bold uppercase tracking-widest text-white/40 mb-1 group-hover:text-[#C59B6D] transition-colors">
                  Max Price
                </p>
            ...
            >
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.2em] whitespace-nowrap relative z-10">
                {matchingCount > 0
                  ? `View ${matchingCount} Asset${matchingCount === 1 ? "" : "s"}`
                  : "No Assets Found"}
              </span>
            </button>
          </div>
      ...
      <section className="py-40 max-w-[1600px] mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
          <div className="lg:col-span-4 lg:pt-8">
            <h2 className="text-5xl md:text-6xl font-display font-bold uppercase tracking-tighter mb-12 text-black leading-none italic">
              About Us
            </h2>
            <div className="space-y-10 max-w-sm">
              <p className="text-[13px] text-black/50 leading-relaxed font-medium">
                Established with a vision to redefine luxury mobility, Lumina
                Motors provides an unparalleled fleet of precision-engineered
                assets. Our legacy is built on the pursuit of automotive
                excellence.
              </p>
              <p className="text-[13px] text-black/50 leading-relaxed font-medium">
                We curate only the finest masterpieces, ensuring every mile
                driven reflects the pinnacle of human engineering.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-4">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              className="overflow-hidden rounded-[2.5rem] shadow-2xl lg:h-[600px]"
            >
              <img
                src="https://images.unsplash.com/photo-1525609004556-c46c7d6cf023?auto=format&fit=crop&q=80&w=1200"
                className="w-full h-full object-cover transition-transform duration-1000 hover:scale-110"
                alt="Main Gallery Car"
              />
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            <div className="bg-[#1A1A1A] text-white rounded-[2.5rem] flex flex-col justify-center items-center text-center shadow-xl h-[150px]">
              <span className="text-4xl lg:text-5xl font-display font-bold tracking-tighter italic">
                +15 years
              </span>
              <span className="text-[9px] uppercase font-bold tracking-[0.4em] opacity-40 mt-1">
                Experience
              </span>
            </div>
            ...
            <motion.div
              whileHover={{ scale: 1.01 }}
              transition={{ duration: 0.6 }}
              className="overflow-hidden rounded-[2.5rem] shadow-2xl h-[436px]"
            >
              <img
        ...
        <div className="flex flex-col lg:flex-row min-h-[700px]">
          <div className="bg-[#3D4C44] text-white p-20 flex-1 flex flex-col justify-center relative overflow-hidden">
            <AnimatePresence mode="wait">
              ...
              >
                <span className="text-[10px] uppercase font-bold tracking-[0.6em] opacity-40 mb-12 block text-white/50">
                  Limited Asset Release
                </span>
                <h2 className="text-4xl md:text-6xl font-display font-bold uppercase tracking-tighter leading-none mb-10 text-white italic">
                  Best <br /> offer
                </h2>
                <div className="mb-14">
                  <h3 className="text-2xl font-display font-bold uppercase tracking-tighter mb-2 text-white">
                    {currentOffer.make} {currentOffer.model}
                  </h3>
                  <div className="flex items-center gap-4">
                    <p className="text-lg opacity-60">
                      for ${currentOffer.price}/day
                    </p>
                    {currentOffer.status === "Reserved" && (
                ...
                <Link
                  to={`/car/${currentOffer.id}`}
                  className="inline-block w-48 py-5 bg-[#C59B6D] text-white rounded-full text-center font-bold uppercase text-[10px] tracking-widest hover:bg-opacity-90 transition-all shadow-xl"
                >
                  Rent Now
                </Link>
              </motion.div>
          ...
          <div className="flex-[1.5] relative flex items-center justify-center p-12 bg-white overflow-hidden">
            ...
            <AnimatePresence mode="wait">
              <motion.img
                ...
                className="relative z-10 w-full max-w-4xl object-contain car-shadow"
                alt={`${currentOffer.make} Offer`}
              />
            </AnimatePresence>
          </div>
        </div>
      ...
      <section className="py-32 bg-white overflow-hidden">
        <div className="max-w-[1600px] mx-auto px-8">
          <div className="flex flex-col md:flex-row justify-between items-baseline mb-20 gap-8">
            <h2 className="text-7xl font-display font-bold uppercase tracking-tight text-black italic">
              Vehicles
            </h2>
            <p className="text-[13px] text-black/30 max-w-sm leading-relaxed font-medium">
              Curating tomorrow's icons through the lens of pure engineering.
              Hover to pause and inspect technical DNA.
            </p>
          </div>
          ...
          >
            ...
            >
              {carouselCars.map((car, idx) => (
                <div
                  key={`${car.id || "car"}-${idx}`}
                  className="flex-shrink-0 w-full md:w-[calc(50%-8px)] lg:w-[calc(31%-12px)]"
                >
                  <Link to={`/car/${car.id || ""}`}>
                    <motion.div
                      whileHover="hover"
                    ...
                    >
                          ...
                          <div className="flex justify-between items-end mb-8 border-b border-white/5 pb-6">
                            <div>
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[8px] font-black uppercase tracking-[0.5em] text-white/50">
                                  Mechanical Profile
                                </span>
                              </div>
                              <h4 className="text-3xl font-display font-bold text-white uppercase italic tracking-tighter leading-none">
                                <span className="text-[10px] font-black opacity-40 block mb-1 not-italic tracking-[0.4em]">
                                  {car.year}
                                </span>
                            ...
                            <div className="text-right">
                              <span className="text-[8px] font-black uppercase tracking-[0.4em] text-white/30 block mb-2">
                                Daily Rate
                              </span>
                              <p
                                className={`text-2xl font-black italic tracking-tighter leading-none ${car.status === "Reserved" ? "text-amber-500" : "text-[#E9C46A]"}`}
                              >
                                $
                                {(
                                  car.rentPrice || Math.round(car.price / 400)
                                ).toLocaleString()}
                                /D
                              </p>
                              {car.status === "Reserved" && (
                                <span className="text-[7px] font-black uppercase tracking-widest text-amber-500 block mt-2">
                                  ALREADY SECURED
                                </span>
                              )}
                            </div>
                      ...
                      >
                        <h3 className="text-4xl font-display font-bold leading-[0.9] tracking-tighter uppercase whitespace-pre-line italic text-white shadow-sm drop-shadow-md">
                          <span className="text-xs block mb-2 opacity-60 not-italic tracking-[0.5em] font-black">
                            {car.year}
                          </span>
                          {car.make} <br />{" "}
                          {car.model ? car.model.split(" ")[0] : ""}
                        </h3>
      ...
      <section className="py-24 bg-[#0A0A0A] relative overflow-hidden">
        <div className="max-w-[1200px] mx-auto px-8 relative z-10">
          <div className="flex flex-col items-center mb-16">
            <span className="text-[9px] font-black uppercase tracking-[0.6em] text-white/20 mb-4 italic">
              Client Feedback
            </span>
          ...
          <div className="flex justify-center items-center h-[380px] relative">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                transition={{ duration: 0.6 }}
                className="w-full max-w-2xl glass-dark border-white/5 p-10 md:p-14 rounded-[2.5rem] shadow-2xl text-center"
              >
                <p className="text-lg md:text-2xl font-display font-bold uppercase tracking-tighter leading-snug mb-8 italic text-white/90">
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  />
                  <div>
                    <h5 className="text-[12px] font-black uppercase tracking-widest text-white">
      ...
      <section className="py-40 bg-white">
        <div className="max-w-[1000px] mx-auto px-8">
          <header className="mb-24 text-center">
            <span className="text-[10px] font-black uppercase tracking-[0.8em] text-black/20 mb-8 block">
              Knowledge Base
            </span>
                  ...
                  {cat.questions.map((item, qIdx) => {
                    ...
                    return (
                      ...
                      >
                        <button
                          onClick={() =>
                            setActiveFaqIdx(isOpen ? null : globalIdx)
                          }
                          className="w-full px-8 py-6 flex justify-between items-center text-left focus:outline-none"
                        >
                          <span className="text-[11px] font-black uppercase tracking-widest text-black/80">
                            {item.q}
                          </span>
                          <ChevronDown
                            size={16}
                            className={`transition-transform duration-500 ${isOpen ? "rotate-180 text-black" : "text-black"}`}
                          />
                        </button>
                        <AnimatePresence>
                          {isOpen && (
          ...
          <div className="mt-20 text-center">
            <Link
              to="/faq"
              className="inline-block text-[10px] font-black uppercase tracking-[0.3em] border-b-2 border-black pb-1.5 hover:border-black/30 transition-all"
            >
              View Detailed FAQ
            </Link>
          </div>
      ...
      <section className="py-40 bg-white border-t border-black/5">
        <div className="max-w-[1600px] mx-auto px-8">
          <div className="flex flex-col md:flex-row justify-between items-baseline mb-20 gap-8">
            ...
            <Link
              to="/blog"
              className="text-[11px] font-black uppercase tracking-[0.3em] border-b-2 border-black pb-1.5 hover:border-black/30 transition-all"
            >
              Explore All Stories
            </Link>
          </div>
            ...
            {BLOGS.slice(0, 3).map((post, idx) => (
              ...
              >
                <Link to={`/blog/${post.id}`}>
                  ...
                  <span className="text-[11px] font-bold text-black/40 uppercase tracking-[0.2em] mb-4">
                    {post.category}
                  </span>
                  <h4 className="text-[22px] font-bold text-black leading-tight mb-5 group-hover:text-black/70 transition-colors">
                    {post.title}
                  </h4>
                  <p className="text-[14px] text-black/50 leading-relaxed font-medium mb-8 line-clamp-3">
                    {post.excerpt}
                  </p>
                  <div className="mt-auto">
                    <span className="inline-block text-[11px] font-black uppercase tracking-[0.2em] border-b-2 border-black pb-1.5">
                      Read Article
                    </span>
                  </div>
                </Link>
      ...
      <section className="py-40 bg-neutral-200 text-center px-8">
        <div className="max-w-xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-display font-bold uppercase tracking-tighter mb-8 text-black italic">
            Subscribe and get 20% off <br /> your first rental.
          </h2>
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              type="email"
              placeholder="YOUR EMAIL..."
              className="flex-1 bg-white border border-black/10 rounded-full px-6 py-4 text-[10px] font-bold uppercase tracking-widest shadow-sm focus:outline-none"
            />
            <button className="bg-black text-white px-8 py-4 rounded-full text-[9px] font-bold uppercase tracking-[0.4em] hover:bg-neutral-800 transition-all">
              Submit
            </button>
          </form>
          <p className="mt-6 text-[8px] font-bold text-black/20 uppercase tracking-[0.3em]">
            Join 5,000+ performance enthusiasts
          </p>
        </div>
      </section>
    </div>
