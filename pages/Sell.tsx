  ...
  const handleFinalSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      await inquiryService.submitInquiry({
        ...
        subject: `Valuation Request: ${formData.makeModel}`,
        message: `Asking Price Goal: ${formData.priceGoal}. Condition: ${formData.condition}.`,
        details: {
          makeModel: formData.makeModel,
          year: formData.year,
          mileage: formData.mileage,
          condition: formData.condition,
          priceGoal: formData.priceGoal,
        },
      });
      setFormStatus("success");
    } catch (error) {
      console.error("Valuation Protocol Error:", error);
      setFormStatus("idle");
      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-start">
          ...
          <div className="space-y-16">
            <header>
              <span className="text-[10px] font-black uppercase tracking-[0.6em] text-[#C59B6D] mb-6 block italic">
                Asset Liquidation
              </span>
              ...
              {[
                {
                  ...
                  desc: "Full high-fidelity media production and provenance verification.",
                },
                {
                  icon: TrendingUp,
                  title: "Strategic Marketing",
                  desc: "Targeted placement across elite global platforms.",
                },
                {
                  icon: DollarSign,
                  title: "Optimized Pricing",
                  desc: "Algorithm-driven valuation based on real-time market indices.",
                },
              ].map((item, i) => (
                <div key={i} className="flex gap-8 group">
                  ...
                  <div>
                    <h4 className="text-xs font-black uppercase tracking-widest mb-2 italic">
                      {item.title}
                    </h4>
            ...
            <div className="mb-12">
              <div className="flex justify-between items-center mb-10">
                ...
                <div className="flex gap-2" aria-hidden="true">
                  {[1, 2, 3].map((s) => (
                    <div
                      key={s}
                      className={`h-1.5 w-8 rounded-full transition-all ${step >= s ? "bg-[#C59B6D]" : "bg-white/5"}`}
                    />
                  ))}
                </div>
              </div>
              ...
              {formStatus === "success" ? (
                ...
                >
                  ...
                  <h3 className="text-2xl font-display font-bold uppercase italic tracking-tighter">
                    Request Initialized
                  </h3>
                  <p className="text-[10px] text-white/40 uppercase tracking-[0.2em]">
                    Our asset analysts will contact you within 4 business hours.
                  </p>
                </motion.div>
              ) : (
                <form
                    ...
                    {step === 1 && (
                      ...
                      >
                        ...
                        <div className="space-y-2">
                          <label
                            htmlFor="make-model"
                            className="text-[9px] font-black uppercase tracking-widest opacity-30 px-6"
                          >
                            Make & Model
                          </label>
                          <input
                      ...
                      >
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            type="text"
                            required
                            value={formData.priceGoal}
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                priceGoal: e.target.value,
                              })
                            }
                            placeholder="$000,000"
                            className="w-full bg-white/5 border border-white/10 rounded-full py-5 px-8 text-[11px] font-black uppercase tracking-widest focus:ring-2 focus:ring-[#C59B6D] focus:outline-none transition-all"
                      ...
                      >
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            placeholder="CONCIERGE@LEGACY.IT"
                            className="w-full bg-white/5 border border-white/10 rounded-full py-5 px-8 text-[11px] font-black uppercase tracking-widest focus:ring-2 focus:ring-[#C59B6D] focus:outline-none transition-all"
                          />
                        </div>
                      </motion.fieldset>
